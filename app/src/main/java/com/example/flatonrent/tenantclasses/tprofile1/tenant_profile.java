package com.example.flatonrent.tenantclasses.tprofile1;
...
public class tenant_profile extends Fragment {
    ...
    Button btnTenantLogout;
    boolean flag1=false;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View root=inflater.inflate(R.layout.activity_tenant_profile, null);
        btnTenantLogout = root.findViewById(R.id.btnTenantLogout);
        ...
        ref= FirebaseDatabase.getInstance().getReference("tenants");
        ...
        root.findViewById(R.id.btnSaveOwnerInfo).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(flag1) {
                    ref1=FirebaseDatabase.getInstance().getReference().child("tenants").child(uid).child("pd");
        ...
        btnTenantLogout.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void loadOwnerImageInformation() {
        ...
        {
            StorageReference ref12=FirebaseStorage.getInstance().getReference().child("tenants").child(uid).child("profilepic").child("myPhoto.jpg");
    ...
    private void uploadImageToFirebaseStorage() {
        ...
        String path="tenants"+"/"+uid+"/"+"profilepic/";
